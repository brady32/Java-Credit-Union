...
private JTextField OpenAccountField, FirstNameField, LastNameField, BalanceField, OverdraftField, WithdrawalField;
		...
		try
			{
				...
				Withdrawal = Double.parseDouble(WithdrawalField.getText());
				...
				Avail = Balance + Overdraft;

				if(Withdrawal >0 && Withdrawal<=Avail)
						{
							data.setBalance(Balance -  Withdrawal);
							JOptionPane.showMessageDialog(this, "Withdrawal Completed");
						}
					else
						{
							JOptionPane.showMessageDialog(this, "Insuffient Funds");
						}
